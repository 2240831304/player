#ifndef AudioFileDecoderMP3_H
#define AudioFileDecoderMP3_H
...
namespace eink {
        ...
        class AudioFileDecoderMp3 : public QObject,public AudioFileDecoder {
		Q_OBJECT
		public :
            AudioFileDecoderMp3(QObject *parent = 0);
            ~AudioFileDecoderMp3();
		...
		private :
            ...
            static AudioFileDecoderMp3 *CurMy;
